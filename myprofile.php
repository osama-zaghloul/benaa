            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-7 mb-5" data-aos="fade">
                        ...
                        <h2 class="mb-5 text-black">Edit my profile</h2>
                            ...
                            if ($rows = mysqli_fetch_assoc($r)) {
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" value="<?php echo $rows['firstName'] ?>" id="text" class="form-control" name="txtfirname">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" value="<?php echo $rows['lastName'] ?>" id="text" class="form-control" name="txtlasname">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input type="phone" value="<?php echo $rows['clientPhone'] ?>" id="subject" class="form-control" name="numphone">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" readonly value="<?php echo $rows['userName'] ?>" id="subject" class="form-control" name="txtusername">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input type="email" value="<?php echo $rows['Email'] ?>" id="subject" class="form-control" name="txtemail">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input type="password" value="<?php echo $rows['password'] ?>" id="subject" class="form-control" name="numpassword">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input type="password" value="<?php echo $rows['password'] ?>" id="subject" class="form-control" name="confpassword">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <input type="submit" value="Update profile" class="btn btn-primary py-2 px-4 text-white" id="btn" name="btnupdate">
                                    </div>
                                </div>
                            <?php
                            }
