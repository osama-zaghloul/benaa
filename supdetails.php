        ...
        <section id="cart">
            ...
            while ($rows = mysqli_fetch_assoc($r)) {
                ...
                <article class="product">
                    <header>
                        <a class="remove">
                            <img src="images/products/<?php echo $rows['product_Id'] ?>.jpg" alt="">

                            <h3><?php echo $rows['categories_Name'] ?></h3>
                        </a>
                    </header>
                    <form method="post">
                        ...
                        <div class="content">
                            ...
                            <h1 style="color:#2d7ec5"><?php echo $rows['product_Name'] ?></h1>
                        ...
                        <footer class="content">
                            ...
                            <h2 class="price">
                                <?php echo $rows['price'] ?> / <?php echo $rows['unit'] ?>
                            </h2>
                        </footer>
