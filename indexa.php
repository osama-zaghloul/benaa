...
?>
          ...
          while ($rows = mysqli_fetch_assoc($r)) {
            ...
            <div class="col-lg-6">
              ...
              <div class="d-block d-md-flex listing">
                <a href="prodetails.php?supId=<?php echo $rows['supId'] ?>" class="img d-block" style="background-image: url('images/supeqimages/<?php echo $rows['supId']; ?>.jpg')"></a>
                <div class="lh-content">
                  <span class="category"><?php echo $rows['supType'] ?></span>
                  <a href="prodetails.php?supId=<?php echo $rows['supId'] ?>" class="bookmark"><span class="icon-building"></span></a>
                  <h3><a href="prodetails.php?supId=<?php echo $rows['supId'] ?>"><?php echo $rows['supName'] ?></a></h3>
                  <address><?php echo ($rows['supCity'] . "," . $rows['supArea'] . " ," . $rows['supStreet']); ?></address>
  ...
  <?php //if(!isset($_session['users'])) {header('location:login.php');}else echo ("Welcom".$_session['users']);
