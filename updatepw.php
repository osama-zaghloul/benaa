...
if (isset($_POST['btnupdate'])) {
    ...
    $client->setpassword($_POST['passwordup']);

    if (isset($_SESSION['data'])) {
        $client->setuserName($_SESSION['data']);
        $client->setEmail($_SESSION['data']);
        echo ($client->Updatepw());
        session_destroy();
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-7 mb-5" data-aos="fade">
                        ...
                        <h2 class="mb-5 text-black">Update password</h2>

                        <form action="#" class="p-5 bg-white" method="post" name="vform">
                            <!-- <div><?php echo ($_SESSION['data']); ?></div> -->
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-12">
                                    <label class="text-black" for="subject">Enter new Password</label>
                                    <input type="password" id="subject" class="form-control" name="passwordup">
                            ...
                            <div class="row form-group">
                                <div class="col-md-12">
                                    <input type="submit" value="Update" class="btn btn-primary py-2 px-4 text-white" name="btnupdate" id="btnl">
