                    ...
                    <div class="col-md-7 mb-5" data-aos="fade">
                        ...
                        <form action="#" class="p-5 bg-white" method="post" name="vform">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-12">
                                    <label class="text-black" for="email">Enter activation code</label>
                                    <input type="text" id="email" class="form-control" name="txtcode">
                            ...
                            <div class="row form-group">
                                <div class="col-md-12">
                                    <input type="submit" value="confirm" class="btn btn-primary py-2 px-4 text-white" name="btnconfirm" id="btnl">
